...
>(({ className, thumbContent, ...props }, ref) => (
  ...
  >
    <SwitchPrimitive.Thumb
      className={cn(
        "bg-background pointer-events-none flex h-5 w-5 items-center justify-center rounded-full shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0"
      )}
    >
      {thumbContent}
    </SwitchPrimitive.Thumb>
